        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card card-blog">
                    <div class="card-img">
                        <a href="${pageContext.request.contextPath}/blog"><img src="img/post-1.jpg" alt="" class="img-fluid"></a>
                    </div>
                    <div class="card-body">
                        ...
                        <h3 class="card-title"><a href="${pageContext.request.contextPath}/blog">See more ideas about Travel</a></h3>
                    ...
                    <div id="contact" class="box-shadow-full">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div>
                                    <form action="${pageContext.request.contextPath}/sendEmail" method="post" role="form" class="contactForm">
